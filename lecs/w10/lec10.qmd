...
<center>
![[http://deeplearning.net/tutorial/fcn_2D_segm.html](http://deeplearning.net/tutorial/fcn_2D_segm.html)](https://miro.medium.com/max/672/1*zH2LJqiFygzBpi7edHEA9w.png){height="300"}
</center>
...
More at [https://github.com/vdumoulin/conv_arithmetic](https://github.com/vdumoulin/conv_arithmetic)
...
If the dimensionality of the embedding space is small,
then the neural network needs to map similar images to
similar locations.

If the dimensionality of the embedding space is **too large**,
then the neural network can simply memorize the images!
...
Read more: [https://ieeexplore.ieee.org/document/8461664](https://ieeexplore.ieee.org/document/8461664)