...
::: {.notes}
* A Neuron is a cell also known as _nerve cell_
...
- If the total activity in a neuron's dendrite lowers the voltage difference
  enough, the entire cell *depolarizes* and the neuron *fires*
...
::: {.notes}
* _Grandmother cells_ are also known as _Jennifer Aniston neurons_
...
<center>
![](imgs/neuron_model.jpeg){ height="300" }
</center>
...
::: {.fragment}
A simple inductive argument shows that for ${\bf x_1}, \dots, {\bf x_N} \in S$,
the **weighted average** or **convex combination** lies in the set:

$$\lambda_1 {\bf x_1} + \dots + \lambda_N {\bf x_N} \in S \text{ for }\lambda_1 + \dots + \lambda_N = 1\ .$$
:::

::: {.notes}
* _iff_ stands for _"if and only if"_
...
::: {.column width="75%"}
::: {.incremental}
- Minsky and Papert shown in their work _Perceptrons_ that XOR cannot be learned by a Neuron.
...
::: {.fragment}
These images represent 16-dimensional vectors.
...
vector (0.25, 0.25, . . . , 0.25). Therefore, this point must be classified as A. All translations of B have the same average. Contradiction!
...
::: {.fragment}
Consider the XOR problem again and use the following feature map:
$$\Psi({\bf x}) = \begin{pmatrix}x_1 \\ x_2 \\ x_1x_2 \end{pmatrix}$$
:::
...
<center>
![](imgs/neural_net.jpeg){ height="270" }
</center>
...
<center>
![](imgs/neural_net2.jpeg){ height="250" }
</center>
...
::: {.notes}
- All the numbers that we can choose such as the number of hidden units are known as _Hyperparameters_.
...
<center>
![](imgs/neural_net.jpeg){ height="200" }
</center>
...
<center>
![](imgs/neural_net.jpeg){ height="300" }
</center>
...
<center>
![](imgs/network_as_features.png){ height="400"}
</center>
...
<center>
![](imgs/features_cartoon.png){ height="400"}
</center>
...
Demo: [https://playground.tensorflow.org/](https://playground.tensorflow.org/)
...
::: {.column width="50%"}
<center>
![](imgs/unreg_computation_graph.png){ height="400"}
</center>
...
<center>
![](imgs/multiway_graph.png){ height="400"}
</center>
...
There are multiple paths for which a weight like
$w_{11}$ affects the loss $\mathcal{L}$.
...
<center>
![](imgs/toy_multivariate_graph.png){ height="250" }
</center>
...
<center>
![](imgs/label_equation.png){ height="250"}
![](imgs/multivariate_context.png){ height="250" }
</center>
...
<center>
![](imgs/message_passing.png){ height="500"}
</center>
...
<center>
![](imgs/backprop_vjp.png){ height="600"}
</center>
...
- Despite its practical success, backprop is believed to be
  neurally (biologically) implausible.
